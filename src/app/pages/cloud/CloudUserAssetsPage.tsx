        ...
        {asset.fileStackType === 'video' ? (
          <div className="w-full h-full flex items-center justify-center bg-gray-900 relative">
            <img
              ...
              loading="lazy"
            />
            <Film size={32} className="absolute text-white drop-shadow" />
          </div>
        ) : (
          <img
            src={unblurUrl(asset.img_url)}
...
export default function CloudUserAssetsPage() {
  ...
  return (
    <div className="space-y-5">
        ...
        {user ? (
          <>
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#ED4C27] text-white font-medium shadow hover:bg-[#d13e1e] transition-colors"
      ...
      {allFolders.length > 0 && (
        <div className="flex items-center gap-2 flex-wrap">
          <span className="text-xs text-gray-400 font-medium uppercase tracking-wide shrink-0">Ordner</span>
