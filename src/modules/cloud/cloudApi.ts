...
/**
 * Formats a clip length in seconds as "m:ss" (or "h:mm:ss" for videos over an hour).
 * Use this whenever the API only returns the raw `duration` and not `duration_formatted`
 * (e.g. on chat messages).
 */
