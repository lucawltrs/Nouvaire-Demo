...
export function Button({
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-[#06b6d4] via-[#22d3ee] to-[#3b82f6] text-white hover:shadow-lg hover:shadow-cyan-500/50 focus:ring-cyan-500',
    secondary: 'bg-gray-700 text-gray-100 hover:bg-gray-600 focus:ring-gray-500',
    danger: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500',
    ghost: 'text-cyan-400 hover:bg-gray-800 focus:ring-cyan-500',
  };
